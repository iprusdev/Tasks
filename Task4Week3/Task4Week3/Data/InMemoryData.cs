...
namespace Task4Week3.Data
{
    public static class InMemoryData
    {
        public static readonly List<Author> Authors = new List<Author>
        {
            ...
            new Author { Id = 3, Name = "Дж.К. Роулинг", DateOfBirth = new DateTime(1965, 31, 5)}
        };
        ...
        public static readonly List<Book> Books = new List<Book>
        {
            ...
            new Book { Id = 4, Title = "Гарри Поттер и философский камень", PublishedYear = 1997, AuthorId = 3}
        };
    }
}